        ...
        messageNoLower.replace(urlRegex, function (url) {
            ...
            $.getJSON(
                ...
                function (data) {
                    ...
                    msgBox.append(
                        `<div style="color:#000000">- ${data.likes} likes</div>`
                    );
                    msgBox.append(
    ...
    if (message.startsWith("!lastfm top ")) {
        ...
        $.getJSON(
            ...
            function (data) {
                ...
                msgBox.append(
                    `<div style="color:#000000">- ${data.user.playcount} tracks scrobbled.</div>`
                );
                msgBox.append(
                    `<div style="color:#000000">- They're from the ${data.user.country}.</div>`
                );
                msgBox.append(
                    `<div style="color:#000000">- They have ${data.user.playlists} playlists.</div>`
                );
                msgBox.append(
                    `<div style="color:#000000">- See more <a href='${data.user.url}'>on their profile</a>.</div>`
                );
                msgBox[0].scrollTop = msgBox[0].scrollHeight;
            }
        );
